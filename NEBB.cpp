...
int main()
{
    double Re = 400, Ma = 0.6, tau, ux, uy, rho, u, term1, term2;
    int Nx, Ny, ix, iy;
    const int q = 9;
    ...
    do
    {
        ...
        ///////Boundary Conditions
        double uxt = uw, uyt = 0.0, uxb = 0.0, uyb = 0.0, uxl = 0.0, uyl = 0.0, uxr = 0.0, uyr = 0.0;
        ...
        for (int j = 2; j <= Ny; j++)
        {
            ...
            f[5][1][j] = f[7][1][j] - (0.5 * (f[2][1][j] - f[4][1][j])) + ((1.0 / 6.0) * (rho_final[1][j] * uxl)) + (0.5 * (rho_final[1][j] * uyl));
            f[8][1][j] = f[6][1][j] + (0.5 * (f[2][1][j] - f[4][1][j])) + ((1.0 / 6.0) * (rho_final[1][j] * uxl)) - (0.5 * (rho_final[1][j] * uyl));
        }

        // Right Wall
        for (int j = 2; j <= Ny; j++)
        {
            rho_final[Nx + 1][j] = (1.0 / (1.0 + uxr)) * (f[0][Nx + 1][j] + f[2][Nx + 1][j] + f[4][Nx + 1][j] + 2 * (f[1][Nx + 1][j] + f[5][Nx + 1][j] + f[8][Nx + 1][j]));
            f[3][Nx + 1][j] = f[1][Nx + 1][j] - ((2.0 / 3.0) * (rho_final[Nx + 1][j]) * (uxr));
            f[7][Nx + 1][j] = f[5][Nx + 1][j] + (0.5 * (f[2][Nx + 1][j] - f[4][Nx + 1][j])) - ((1.0 / 6.0) * (rho_final[Nx + 1][j] * uxr)) - (0.5 * (rho_final[Nx + 1][j] * uyr));
            f[6][Nx + 1][j] = f[8][Nx + 1][j] - (0.5 * (f[2][Nx + 1][j] - f[4][Nx + 1][j])) - ((1.0 / 6.0) * (rho_final[Nx + 1][j] * uxr)) + (0.5 * (rho_final[Nx + 1][j] * uyr));
        }
        ...
        // f[6][1][1] = 0.5 * (rho_final[1][2] - (f[0][1][1] + f[1][1][1] + f[2][1][1] + f[3][1][1] + f[4][1][1] + f[5][1][1] + f[7][1][1]));
        // f[8][1][1] = 0.5 * (rho_final[1][2] - (f[0][1][1] + f[1][1][1] + f[2][1][1] + f[3][1][1] + f[4][1][1] + f[5][1][1] + f[7][1][1]));
        ...
        // f[5][1][Ny + 1] = 0.5 * (rho_final[1][Ny] - (f[0][1][Ny + 1] + f[1][1][Ny + 1] + f[2][1][Ny + 1] + f[3][1][Ny + 1] + f[4][1][Ny + 1] + f[6][1][Ny + 1] + f[8][1][Ny + 1]));
        // f[7][1][Ny + 1] = 0.5 * (rho_final[1][Ny] - (f[0][1][Ny + 1] + f[1][1][Ny + 1] + f[2][1][Ny + 1] + f[3][1][Ny + 1] + f[4][1][Ny + 1] + f[6][1][Ny + 1] + f[8][1][Ny + 1]));
        ...
        // f[6][1][1] = 0.5 * (rho_final[Nx + 1][Ny] - (f[0][1][1] + f[1][1][1] + f[2][1][1] + f[3][1][1] + f[4][1][1] + f[5][1][1] + f[7][1][1]));
        // f[8][1][1] = 0.5 * (rho_final[Nx + 1][Ny] - (f[0][1][1] + f[1][1][1] + f[2][1][1] + f[3][1][1] + f[4][1][1] + f[5][1][1] + f[7][1][1]));
        ...
        // f[5][Nx + 1][1] = 0.5 * (rho_final[Nx + 1][2] - (f[0][Nx + 1][1] + f[1][Nx + 1][1] + f[2][Nx + 1][1] + f[3][Nx + 1][1] + f[4][Nx + 1][1] + f[6][Nx + 1][1] + f[8][Nx + 1][1]));
        // f[7][Nx + 1][1] = 0.5 * (rho_final[Nx + 1][2] - (f[0][Nx + 1][1] + f[1][Nx + 1][1] + f[2][Nx + 1][1] + f[3][Nx + 1][1] + f[4][Nx + 1][1] + f[6][Nx + 1][1] + f[8][Nx + 1][1]));
    ...
    // for (int i = 1; i <= Nx + 1; i++)
    // {
    //     psi[i][1] = psi[i - 1][1] + 1.0 * uy_final[i][1];
    // }
    // for (int j = 1; j <= Ny + 1; j++)
    // {
    //     psi[1][j] = psi[1][j - 1] - 1.0 * ux_final[1][j];
    // }
